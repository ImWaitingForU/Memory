...
import com.chan.app.myapplication.FragmentMemory;
import com.chan.app.myapplication.R;
import com.chan.app.myapplication.ShowMemory;
        ...
        if (entity != null) {
            ...
            convertView.findViewById(R.id.item_surface).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i = new Intent(context,ShowMemory.class);
                    i.putExtra("time", FragmentMemory.timeList.get(groupPosition));
                    i.putExtra("allMsg", FragmentMemory.msgList.get(groupPosition));
                    i.putExtra("objectId",FragmentMemory.objectId.get(groupPosition));
